...
|  ---                   |  ---     |
| Commands & Actions: <br> <br> Words are bold to represent a command or action you must perform. | **Click, Insert** <br> |
| Buttons: <br> <br> Buttons are enclosed with square brackets. | [Button] <br> |
| Column Name: <br> <br> Column name have a block of grey background color. | ```Column name``` <br> |
